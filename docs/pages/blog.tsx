...
export default function Blog(props: InferGetStaticPropsType<typeof getStaticProps>) {
  ...
  return (
    <BrandingCssVarsProvider>
      <Head
        title="Blog - @hoangndst"
        description="If you know, you don't know, you're smart."
        disableAlternateLocale
      />
      <AppHeader />
      <main id="main-content">
        <Section bg="gradient" sx={{ backgroundSize: '100% 300px', backgroundRepeat: 'no-repeat' }}>
          <Typography variant="body1" color="primary.600" fontWeight="bold" textAlign="center">
            Blog
          </Typography>
          <Typography component="h1" variant="h6" textAlign="center" sx={{ mb: { xs: 5, md: 10 } }}>
            &quot;If you know, you don&apos;t know, you&apos;re smart.&quot;
          </Typography>
          <Box
            component="ul"
            sx={{
