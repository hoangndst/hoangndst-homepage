...
export const authors = {
  ...
  hoangndst: {
    ...
    avatar: 'https://avatars.githubusercontent.com/u/63186170',
    github: 'hoangndst',
  }
};
...
function TopLayoutBlog(props) {
  ...
  const card =
    headers.card === 'true'
      ? `https://hoangndst.freeddns.org/static/blog/${slug}/card.png`
      : 'https://hoangndst.freeddns.org/static/logo.png';
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              publisher: {
                '@type': 'Organization',
                name: 'MUI blog',
                url: 'https://hoangndst.freeddns.org/blog/',
                logo: {
                  '@type': 'ImageObject',
                  url: 'https://hoangndst.freeddns.org/static/icons/512x512.png',
                },
              },
              author: {
                '@type': 'Person',
              ...
              headline: finalTitle,
              url: `https://hoangndst.freeddns.org${canonicalAsServer}`,
              ...
              mainEntityOfPage: {
                '@type': 'WebPage',
                '@id': 'https://hoangndst.freeddns.org/blog/',
              },
            }),
          }}
        />
