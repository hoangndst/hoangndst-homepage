        ...
        <SectionHeadline
          ...
          title={
            <Typography variant="h2" sx={{ maxWidth: 460, mb: 1 }}>
              <GradientText>My email</GradientText>
            </Typography>
          }
          description="If you have any suggestion, project or even you want to say “hello”, please contact and I will reply you shortly."
        />
        <GetStartedButtons />
      </Grid>
