...
date: '2021-05-28'
lastmod: '2021-05-28'
tags: ['machine-learning', 'optimization', 'gradient-descent', 'tutorial']
...
1. [Introduction](#1-introduction) <br />
    1.1. [Why do we need GD?](#11-why-do-we-need-gd) <br />
    1.2. [Method](#12-method) <br />
2. [Gradient Descent and Linear Regression](#2-gradient-descent-and-linear-regression) <br />
    2.1. [Matrix Derivatives](#21-matrix-derivatives) <br />
    2.2. [Numerical Differentiation](#22-numerical-differentiation) <br />
    2.3. [Simulation with Python](#23-simulation-with-python) <br />
3. [Going into more detail](#3-going-into-more-detail) <br />
    3.1. [When to stop?](#31-when-to-stop) <br />
    3.2. [Stuck at local minima](#32-stuck-at-local-minima) <br />
    3.3. [Learning Rate](#33-learning-rate) <br />
...
<details>
<summary>Code <a href="#figure-2">Figure 2</a>: Gradient Descent Animation</summary>
```python
...
<details>
<summary>Code <a href="#figure-3b">Figure 3.2</a>: Gradient Descent Animation 2</summary>
```python
import numpy as np
